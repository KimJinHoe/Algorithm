...
/*
백준 아이디 01089292615님의 코드 분석 및 재현
BigInteger는 무한대의 수를 표현할 수 있는 객체
 */
import java.io.*;
import java.math.BigInteger;
import java.util.Stack;

public class Boj_1287_할수있다_Solution {
    ...
    private static boolean calc(Stack<BigInteger> nums, char op) throws IOException {
        ...
        //이 해답에서는 2+0처럼 두번째 수가 0이 나오면 ROCK으로 했는데 올바른 정답은 '/'일 때만 ROCK이어야 함
